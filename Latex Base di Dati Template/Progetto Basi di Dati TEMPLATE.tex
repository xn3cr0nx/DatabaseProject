...
% le à/è/ò/ù accentate e perdete un sacco di tempo, con questa impostazione da ripetere
...
%per mettere in input un file latex questa è la forma
...
% Include un indice che viene creato automaticamente, senza il pacchetto babel latin si chiamerà contents
\tableofcontents 
...
%----------------------------------------------------------------------------------------
	...
	\input{./Sezioni/analisireqintro}
		...
		L'unica Ambiguità presente sembra essere la definizione delle Statistiche del personaggio, che sono le stesse anche per gli NPC e per le abilità che le modificano, per non fare confusione con la definizione di Attributo dei database abbiamo scelto di usare Statistiche.
...
%------------------------------------------------
	\section{Progettazione Concettuale} 
		...
		\subsection{Strategia di Progetto }
			Svilupperemo lo schema concettuale con un approccio misto, cioè partiremo da dei concetti astratti principali che descrivono le specifiche in modo blando e andremo a raffinarli (strategia top-down), procederemo nella raffinazione fino ad arrivare ad un soddisfacente grado di dettaglio per poi correggere lo schema secondo una strategia inside-out.
