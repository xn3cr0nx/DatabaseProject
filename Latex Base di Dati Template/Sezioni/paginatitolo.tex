...
\HRule \\[0.4cm]
{ \huge \bfseries Progettazione di una Base di Dati per un Gioco di Ruolo Online}\\[0.4cm] % Title of your document
\HRule \\[1.5cm]
...
\emph{Autori:}\\
Quirino \textsc{Puglia}\\ % Your name
Lorenzo \textsc{Olivieri}\\ % Your name
Francesco Maria \textsc{Falini}\\ % Your name
\end{flushleft}
\end{minipage}
~
\begin{minipage}{0.4\textwidth}
...
\emph{Revisore:} \\
Dr. Emanuele \textsc{Storti} % Supervisor's Name
\end{flushright}
\end{minipage}\\[1.5cm]
